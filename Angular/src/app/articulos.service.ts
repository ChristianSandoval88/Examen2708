...
export class ArticuloService {
  private apiUrl = 'https://localhost:7053/api/Articulos';
  private apiUrlTiendas = 'https://localhost:7053/api/Tiendas';
  constructor(private http: HttpClient) {}
  getAll(){ return this.http.get<any[]>(this.apiUrl); }
  getAllTiendas(){ return this.http.get<any[]>(this.apiUrlTiendas); }
